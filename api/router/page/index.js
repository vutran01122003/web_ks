...
const { QueryPageSchema } = require("../../schema/page.schema");
...
router.get("/page/:pageName", auth, checkPermission, validateResource(QueryPageSchema), pageControllers.getPage);
