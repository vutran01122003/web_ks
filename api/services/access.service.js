    ...
    static login = async (data) => {
        try {
            ...
            if (user) {
                ...
                return {
                    isSuccessLogin: !resText.includes(
