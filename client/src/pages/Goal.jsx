                ...
                {!handleAddTable && (
                    <div className="goals_info_wrapper">
                        <div className="faculty_info">
                            ...
                            >
                                {(pageStudentMajor || pageFaculty) &&
                                pageStudentMajor?.cohortList ? (
                                    <>
                                        <option value="">Chọn Khóa</option>

                                        {pageStudentMajor.cohortList.map(
                                            (cohort) => (
                                                <option
                                                    key={cohort._id}
                                                    value={JSON.stringify(
