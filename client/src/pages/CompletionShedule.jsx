...
import no_search_result from '../assets/images/no_search_result.jpg';
...
function CompletionShedule() {
    ...
    const handleSearchAnnualTaskProgress = () => {
        if(cohort && major && levelYear) {
            dispatch(getAnnualTaskProgress({
                cohort,
                major,
                levelYear,
                studentId,
                    ...
                    <tbody className='completion_shedule_body'>
                        {
                            progress.annualTaskProgress.data.map((progressItem, index) => (
                                <tr key={progressItem?.studentId}>
                                    ...
                                    <td>{progressItem.completedTaskProgress?.completedTaskPrecent.toFixed(2) + "%"}</td>
