        ...
        <div className="person__info">
            ...
            <div className="info__items">
                <div className="info__text">
                    <LineItem info="Ngày sinh" text={moment(user?.birthday).format('DD/MM/YYYY') || 'Chưa cập nhật'} />
                    ...
                    <LineItem info="Số điện thoại" text={user?.phone || 'Chưa cập nhật'} />
                </div>
                <div className="info__text">
                    ...
                    <LineItem info="Email" text={user?.email || 'Chưa cập nhật'} />
                </div>
                <div className="info__text">
